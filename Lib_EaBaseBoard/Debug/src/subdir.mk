...
src/%.o: ../src/%.c src/subdir.mk
	...
	arm-none-eabi-gcc -DDEBUG -D__CODE_RED -D__REDLIB__ -I"C:\Users\nikod\Downloads\E13_V7_final\E13_alarm_V3\Lib_CMSISv1p30_LPC17xx\inc" -I"C:\Users\nikod\Downloads\E13_V7_final\E13_alarm_V3\Lib_EaBaseBoard\inc" -I"C:\Users\nikod\Downloads\E13_V7_final\E13_alarm_V3\Lib_MCU\inc" -O0 -g3 -gdwarf-4 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m3 -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
